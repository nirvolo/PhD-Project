...
#'
#' This function implements Generalized Quasi-Likelihood Ratio (GQLR) test using wild bootstrap.
#'
...
#'
#' This is an internal function of package \code{SVCM}.
#'
